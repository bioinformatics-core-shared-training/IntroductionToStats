...
install.packages(c("ggplot2", "reshape2","gridExtra","RColorBrewer","knitr"))
...
\author{Sarah Vowler and Mark Dunning \thanks{Acknowledgements: Sarah Dawson, Elizabeth Merrall and Deepak Parashar}}
...
RcmdrMisc:::plotDistr(.x, dt(.x, df=11), cdf=FALSE, xlab="x", ylab="Density", main=paste("t Distribution:  Degrees of freedom=11"))
...
xtable(cell,caption="Cellularity at two sites of disesase",label="cellularity")
@
...
RcmdrMisc:::plotDistr(.x, dchisq(.x, df=1), cdf=FALSE, xlab="x", ylab="Density", main=paste("ChiSquared Distribution:  Degrees of freedom=1"))
