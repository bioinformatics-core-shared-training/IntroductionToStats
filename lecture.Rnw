...
\begin{frame}[fragile]{Continuous or not??}
...
Mean = $(2.9 + \dots + 3.40) / 12 = \Sexpr{me}$

Standard deviation = \Sexpr{sd}
\begin{itemize}
...
Mean of breed A: \Sexpr{round(mean(mice$WeightA),2)}
Mean of breed B: \Sexpr{round(mean(mice$WeightB),2)}

Standard Deviation of breed A: \Sexpr{round(sd(mice$WeightA),2)}
Standard Deviation of breed B: \Sexpr{round(sd(mice$WeightB),2)}
